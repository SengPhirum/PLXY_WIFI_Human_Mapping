...
Continuity folder: everything needed to pick this project up cold (e.g.
from a different Claude account or a new machine).

| File | Read when |
|---|---|
| `PROJECT_STATUS.md` | **Start here.** What's done, current results, how to run, next steps |
